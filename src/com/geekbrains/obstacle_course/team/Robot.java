...
public class Robot implements Opponents{

        public Robot(String name, double max_distance, double max_height) {
            this.name = name;
        ...
        public String jump(double height) {
            ...
            if (height <= max_height) {
                ...
                onTeam = false;
                result = name + " не может так высоко прыгнутьи выбывает.";
            }
            return result;
        }
